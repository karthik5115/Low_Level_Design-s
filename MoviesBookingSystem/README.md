...
├── Booking.java           # Booking entity (user, show, seats, payment)
├── BookingController.java # Booking orchestration & payment execution
├── City.java              # City enum (BANGALORE, DELHI, MUMBAI, etc.)
├── Location.java          # Location model supporting City integration
├── Movie.java             # Movie entity (id, name, duration, language)
├── MovieController.java   # Movie management controller by location
├── Payment.java           # Payment entity with PaymentStatus & PaymentMethod enums
